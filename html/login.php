...
<body>
    <div class="login">
        ...
        <div>
            <input type="button" value="Entrar" class="btn-entrar" onclick="validaCampos()">
            <input type="button" value="Limpar" class="btn-entrar" onclick="limpaCampos()">
        </div><br>
    </form>
        <div>
            <a href="cadastro.html"><input type="button" value="Cadastrar uma conta" class="btn-cadastrar"></a>
        </div>
    </div>
    <script>
