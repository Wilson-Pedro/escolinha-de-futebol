...
<body>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-menu">
                            <li>
                                ...
                                <a href="historicoPartidas-admin.php" id="marcado">HISTÓRICO DE PARTIDAS</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item">
    ...
    <main>
        ...
        if (isset($_POST['atualizar']) && isset($_POST['id_editado']) && isset($_POST['gols_lyon_editado']) && isset($_POST['gols_adv_editado'])) {
            ...
            $sql = $pdo->prepare("UPDATE tblpartidas SET gols_lyon = :gols_lyon, gols_adv = :gols_adv WHERE id= :id");
